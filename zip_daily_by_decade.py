# zip the daily files in 10year chunks...
...
def zip_it( df, output_path ):
	...
	out_fn = os.path.join( output_path, variable.lower(), '{}_daily_wrf_{}_{}.zip'.format( variable,group_name,decade ) )
...
if __name__ == '__main__':
	...
	base_path = '/workspace/Shared/Tech_Projects/wrf_data/project_data/wrf_data/daily_fix'
	output_path = '/workspace/Shared/Tech_Projects/wrf_data/project_data/data_zips/welty/daily'

	# groupnames
	groups = [ 'GFDL-CM3_historical','GFDL-CM3_rcp85','ERA-Interim' ]
	# varnames =  ['pcpc', 'pcpnc', 'pcpt', 'q2', 'snowh', 'swdnb', 't2'] # hansen
	# varnames = ['acsnow','cldfra','hfx','lh','lwdnb','lwupb', 'q2', 'snow', 'snowh', 'swdnb', 'swupb'] # welty
	varnames = ['acsnow','cldfra','hfx','lh','lwdnb']
