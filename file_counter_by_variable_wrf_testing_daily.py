...
base_dir = '/workspace/Shared/Tech_Projects/wrf_data/project_data/wrf_data/monthly'
# base_dir = '/storage01/malindgren/wrf_ccsm4/monthly'
...
counts2 = list(zip(*[ i.ravel().tolist() for i in np.unique(df.variable, return_counts=True)]))
