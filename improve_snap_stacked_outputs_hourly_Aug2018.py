...
if __name__ == '__main__':
    ...
    files = [ fn for fn in files if 'T2_' in fn or 't2_' in fn ]
    ...
    wrf_raw_mod_fn = '/storage01/pbieniek/gfdl/hist/hourly/1970/WRFDS_d01.1970-02-22_21.nc'# not raw, but pre-processed by Peter
    var_attrs_lookup = make_variable_lookup( wrf_raw_mod_fn )
    ...
    # run
    f = functools.partial( run, meta=meta )
    pool = mp.Pool( 10 )
