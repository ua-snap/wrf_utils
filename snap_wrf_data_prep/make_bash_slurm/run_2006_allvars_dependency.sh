...
# # echo $jobs
# joblist='"$jid01": "$jid02"'
# joblist=$(printf '%s: %s' "$jid01" "$jid02")
joblist=(`squeue -u malindgren --noheader -o "%i" | sed -n '1h;2,$H;${g;s/\n/:/g;p}'`)
echo $joblist

# jid999=$(sbatch T_2006_gfdl_rcp85.slurm --d afterany:$joblist)
sbatch -d afterany:$joblist T_2006_gfdl_rcp85.slurm
