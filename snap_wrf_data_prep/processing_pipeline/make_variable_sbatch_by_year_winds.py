# make the sbatch slurm scripts for processing the wind variables
# intent for this script at time of creation is for re-processing
# only the wind variables.
...
def write_batch_winds(fn, variable, output_filename, year, input_path, dione_path,group):
    ...
    args = "SCRIPTNAME=/workspace/UA/kmredilla/wrf_utils/snap_wrf_data_prep/stack_hourly_variable_year_winds.py\n"+\
            "DIONEPATH={}\n".format(dione_path)+\
            "INPATH={}\n".format(input_path)+\
...
if __name__ == '__main__':
    ...
    for group in groups:
        ...
        input_path='/atlas_scratch/kmredilla/WRF/wind-issue/{}'.format(group)
        output_path = '/atlas_scratch/kmredilla/WRF/wind-issue/restacked'
        ...
        for year, variable in itertools.product(years, variables):
            ...
            fn = '/atlas_scratch/kmredilla/WRF/wind-issue/restacked/slurm_scripts/{1}/{0}_{1}_{2}.slurm'.format(variable,year,group)
